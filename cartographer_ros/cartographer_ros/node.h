...
class Node
{
  ...
  private:
    ...
    bool HandleSubmapCloudQueryStub(cartographer_ros_msgs::SubmapCloudQuery::Request &request,
                                cartographer_ros_msgs::SubmapCloudQuery::Response &response);
    ...
    void PublishTrajectoryPoseList(const ::ros::WallTimerEvent &timer_event);
    ...
    ::ros::Publisher trajectory_pose_list_publisher_;
